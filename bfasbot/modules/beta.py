...
sleeptime = 0
from bfasbot import (BOT, cmds, AFKREASON, COUNT_MSG, ISAFK, LOGGER, LOGGER_GROUP, USERS, HELPER, run_async)
...
@BOT.on_message(Filters.me & Filters.command('xcc', cmds))
@run_async
...
@BOT.on_message(Filters.command('sg', cmds))
@run_async
